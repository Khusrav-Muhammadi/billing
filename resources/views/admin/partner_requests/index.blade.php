        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                @foreach($partnerRequests as $partner)
                            ...
                            <form action="{{ route('partner-request.approve', $partner->id) }}" method="POST">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#reject_cause"><button type="button" class="btn btn-danger" data-bs-dismiss="modal">Отклонить</button></a>
                    ...
                    <div class="modal fade" id="reject_cause" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="{{ route('partner-request.reject', $partner->id) }}" method="POST">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <textarea name="reject_cause" id="" cols="30" rows="5" class="form-control" placeholder="Почему вы отклоняете этот запрос?"></textarea>
                                    </div>
                                    <div class="modal-footer">
