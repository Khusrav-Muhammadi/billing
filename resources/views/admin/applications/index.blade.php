            ...
            <table class="table table-hover">
                ...
                @foreach($applications as $application)
                    <tr>
                        ...
                        <td>{{ $application->partnerStatus?->name }}</td>
                        <td>{{ $application->address }}</td>
                        <td>
                            <a href="" data-bs-toggle="modal" data-bs-target="#history{{ $application->id }}" type="button">
                                <i class="mdi mdi-history" style="font-size: 30px; color: #3D3D3D"></i>
                            </a>
                            <a href="{{ route('partner.edit', $application->id) }}"><i class="mdi mdi-pencil-box-outline" style="font-size: 30px"></i></a>
                            <a href="" data-bs-toggle="modal" data-bs-target="#deleteClient{{$application->id}}"><i style="color:red; font-size: 30px" class="mdi mdi-delete"></i></a>
                        </td>
                    </tr>
                    <div class="modal fade" id="deleteClient{{$application->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="{{ route('partner.delete', $application->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="modal fade" id="history{{ $application->id }}" tabindex="-1"
