...
//        if ($request->ajax()) {
//            return view('admin.partials.sub_domains', compact('clients'))->render();
//        }

        return view('v2.sub_domains.index', compact('clients', 'partners', 'tariffs', 'managers'));
    }
    ...
    public function show(Client $client)
    {
        ...
        return view('v2.sub_domains.show', compact('client', 'organizations', 'transactions', 'businessTypes', 'packs', 'tariffs', 'sales', 'partners', 'expirationDate', 'countries'));
    }
