...
class CommercialFooferController extends Controller
{
    ...
    private function buildCommercialConfig(int $asOfTs): array
    {
        ...
        foreach ($tariffs as $tariff) {
            ...
            $tariffsForJs['tariff-' . (int)$tariff->id] = [
                ...
                'category' => $tariff->category !== null && $tariff->category !== '' ? (string)$tariff->category : null,
                'isPublic' => (bool)($tariff->is_public ?? false),
        ...
        foreach ($services as $service) {
            ...
            $servicesForJs['service-' . (int)$service->id] = [
                ...
                'category' => $service->category !== null && $service->category !== '' ? (string)$service->category : null,
                ...
                'isPublic' => (bool)($service->is_public ?? false),
    ...
    private function normalizeCurrencyPrices(
        ...
        return $this->normalizeExplicitCurrencyPrices($prices, $currencyCodes);
    }
