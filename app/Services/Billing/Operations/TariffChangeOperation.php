...
class TariffChangeOperation extends BaseBillingOperation
{
    ...
    public function getMetadata(): array
    {
        return [
            ...
            'license_difference' => $this->newTariff->license_price > $this->client->tariffPrice->license_price ? ($this->newTariff->license_price - $this->client->tariffPrice->license_price - $this->organization->sum_paid_for_license) : 0,
