...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('clients/getOrganizations/{id}', [\App\Http\Controllers\API\ClientController::class, 'getOrganizations']);
    Route::get('clients/getTransactions/{id}', [\App\Http\Controllers\API\ClientController::class, 'getTransactions']);
